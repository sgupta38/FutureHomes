...
#define OUT_PIN_NUMBER  14 // This is the GPI0 pin number 14 on my circuit. (D5)
...
void loop() {
  ...
  while ((subscription = mqtt.readSubscription(5000))) {
    if (subscription == &Light) {
      ...
      digitalWrite(OUT_PIN_NUMBER, num); // built in LED GPIO2(default)
    }
  }
